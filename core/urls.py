...
urlpatterns = [
    ...
    path('questions/<str:pk>/', views.QuestionListCreateView.as_view(), name='question-create'),
    ...
    path('clientnotifications/', views.ClientNotifications.as_view(), name='clientNotifications'),
