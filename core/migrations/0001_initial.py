    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_type', models.CharField(blank=True, choices=[('Remote', 'Remote'), ('On-site', 'On-site'), ('Hybrid', 'Hybrid')], max_length=500, null=True)),
                ...
                ('images', models.ManyToManyField(to='core.gallery')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('reviewed', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.talentprofile')),
                ('reviewer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.clientprofile')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
